package SemesterHomework2;

import java.io.BufferedReader;
import java.io.FileReader;
import java.io.IOException;

import static SemesterHomework2.FibHeap.create_heap;


public class main {
    public static void main(String[] args) {
        // создаем массив и записываем в него числа из файла
...
//        double[] minTime = new double[101];
//        for (int i = 0; i < 100; i++) {
//            double start = System.nanoTime();
//            obj.find_min();
//            double finish = System.nanoTime();
//            minTime[i] = (finish - start);
//        }
//        double sumMin = 0;
//        for (int i = 0; i < 100; i++) {
//            sumMin += workingTime[i];
//        }
//        double averageMin = sumMin / 100;
//        System.out.println();
//        System.out.println("Среднее время вывода минимального : " + averageMin);
